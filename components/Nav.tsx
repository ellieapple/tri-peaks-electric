...
export default function Nav() {
  ...
  return (
    <>
      <div className="fixed top-0 left-0 right-0 z-50 bg-[#051e26] text-white/80 text-xs h-8 hidden md:flex items-center justify-center border-b border-white/10">
        Licensed and insured electrical contractor serving Bailey, Conifer, Evergreen, and the 285 Corridor
      </div>
      <nav
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-[#082933] ${scrolled ? "shadow-lg shadow-black/30" : ""} md:top-8`}
      >
